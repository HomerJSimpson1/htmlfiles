...
$(document).ready(function() {
    ...
    cur_template = $("animal-classes-template").html();
    ...
    // Use the click even to display the animal class data
    $("#animal-class-template").click(function() {
	// display the animal class template
	showTemplate(animal_class_template, current_class);

	// Make the Animal Class Tab the active one
	$(".nav-tabs .active").removeClass("active");
	$("#animalclass-tab").addClass("active");
