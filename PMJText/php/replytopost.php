<?php
	...
	if (!$_POST) {
		...
		$verify_sql = "SELECT ft.topic_id, ft.topic_title 
		       FROM forum_posts AS fp INNER JOIN forum_topics as ft
...
<html language="en">
	...
	<form method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>">
	  <p>
		<label for="post_owner">Your Email Address:</label><br>
	  ...
	  <button type="submit" names="submit" value="submit">Add Post</button>
	</form>
      </body>
</html>

<?php
		} // end else for the if(mysqli_num_rows < 1) clause
